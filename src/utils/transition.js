...
export const toTransitionToken = (transition, direction) => {
    if (transition === 'slide') {
 ...
 */
export const applyTransitionVars = (duration, easing) => {
    ...
    if (duration !== undefined)
        root.style.setProperty('--vtr-duration', `${duration}ms`);
    if (easing !== undefined)
        root.style.setProperty('--vtr-easing', easing);
